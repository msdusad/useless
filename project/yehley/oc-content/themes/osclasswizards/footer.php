...
<footer id="footer">
  <div class="container">
    <div class="footer">
      ...
      <?php
            echo '<div class="copyright">' . sprintf(__('Copyright © 2016 <a target="_blank" title="osclasswizards" href="%s">Yehley.in</a>',OSCLASSWIZARDS_THEME_FOLDER), 'http://www.yehley.in/') . '</div>';
        ?>
    </div>
  </div>
</footer>
