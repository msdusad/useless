...
$db->execute("SELECT jobseeker_profile_img FROM tb_jobseeker WHERE jobseeker_id='$_SESSION[jobseeker_id]' LIMIT 1");

$update_pic=$db->getResult();

$delete=$update_pic['jobseeker_profile_img'];
	...
	if (in_array($file["type"],$fileTypes) && in_array($file_extension, $extensions)) {
...

		{
			...
			if(move_uploaded_file($sourcePath,$targetPath)){
				...
				$db->execute("UPDATE tb_jobseeker SET jobseeker_profile_img='$actual_image_name' WHERE jobseeker_id='$_SESSION[jobseeker_id]'");	
