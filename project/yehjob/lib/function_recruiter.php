...
class search
{
	...
	public function deleteJob(){
			$this->db->execute("DELETE FROM tb_post_job WHERE post_job_id = '$_SESSION[post_job_id]'");
			$this->db->execute("DELETE FROM tb_location WHERE post_job_id = '$_SESSION[post_job_id]'");
			$this->db->execute("DELETE FROM tb_category WHERE post_job_id = '$_SESSION[post_job_id]'");
			$this->db->execute("DELETE FROM tb_qualifications WHERE post_job_id = '$_SESSION[post_job_id]'");
			$this->db->execute("DELETE FROM tb_job_like WHERE job_id ='$_SESSION[post_job_id]'");
			return "success";
	}
}
?>
