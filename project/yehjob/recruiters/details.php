	...
	if(!empty($_SESSION['job_id']) && empty($_SESSION['recruiter_id'])) 
	{
		die("<script>location.href = 'http://www.yehjob.com/recruiter_login.php'</script>");
	} elseif (empty($_SESSION['recruiter_id'])) {
					...
					<div class="upload_text">
						...
						<div class="below_details">
							...
							<div class="below_detail_inner">
								...
								<p><?php  echo  trim($job_details['job_description']);?></p>
